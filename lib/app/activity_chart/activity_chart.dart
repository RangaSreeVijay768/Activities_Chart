import 'package:activities_chart/app/activity_chart/activity_chart_controller.dart';
import 'package:activities_chart/app/activity_chart/activity_chart_cubit.dart';
import 'package:activities_chart/app/activity_chart/activity_chart_roaming/activity_chart_roaming.dart';
...
class ActivityChartScreen extends BaseStatelessWidget<ActivityChartController, ActivityChartCubit> {
          ...
          return Scaffold(
            appBar: AppBar(
              ...
              title: Container(
                ...
                child: const Text("Activities Chart",
                        ...
                        children: [
                          Container(
                            ...
                            child: state.when(
                              ...
                              internetError: () => const ActivityChartInternetError(),
                                          ...
                                          Expanded(
                                              child: Container(
                                                ...
                                                child: TextButton(
                                                    ...
                                                    onPressed: (){
                                                      Navigator.of(context).push(MaterialPageRoute(builder: (context) => ActivityDetailsScreen(
  ...
  ActivityChartCubit createCubitAndAssignToController(BuildContext context) {
    ActivityChartCubit activityChartCubit =
        ActivityChartCubit();
